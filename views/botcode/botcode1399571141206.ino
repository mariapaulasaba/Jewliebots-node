...
int loopCycle;
int loopSteps = 10;
int timeStamps[] = {0,1000,1500,2500,3000,4000,4500,5500,6000,7000,7500};
...
void loop(){
	...
	else if(timePassed < timeStamps[7]){

	on(0,0,255,3);
	}

	else if(timePassed < timeStamps[8]){

	off(3);
	}

	else if(timePassed < timeStamps[9]){

	on(0,0,255,0);
	}

	else if(timePassed < timeStamps[10]){
