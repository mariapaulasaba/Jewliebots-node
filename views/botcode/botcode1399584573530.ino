...
int loopCycle;
int loopSteps = 6;
int timeStamps[] = {0,1000,2000,3000,4000,9000,14000};
...
void loop(){
	...
	else if(timePassed < timeStamps[1]){

	on(255,0,255,0);
	}

	else if(timePassed < timeStamps[2]){

	blinkLoop(140,0,255,1,10);
	}

	else if(timePassed < timeStamps[3]){

	blinkLoop(255,0,255,2,10);
	}

	else if(timePassed < timeStamps[4]){

	blinkLoop(140,0,255,3,10);
	}

	else if(timePassed < timeStamps[5]){

	blinkLoop(255,0,255,4,10);
	}

	else if(timePassed < timeStamps[6]){
...
void doubleclick(){
	...
	blinkEvent(255,255,0,1,1000,10);

	blinkEvent(0, 255, 255,2,1000,10);

	blinkEvent(0,0,255,3,1000,10);

	blinkEvent(140,0,255,4,1000,10); 
}
